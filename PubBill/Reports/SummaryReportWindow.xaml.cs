...
public partial class SummaryReportWindow : Window
{
	...
	public SummaryReportWindow(LoginWindow loginWindow)
	{
		InitializeComponent();
	...
	private void ItemReport(object sender, System.Windows.Input.ExecutedRoutedEventArgs e)
	{
		ItemReportWindow itemReportWindow = new(_fromDateTime, _toDateTime);
